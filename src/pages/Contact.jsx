      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="max-w-2xl mb-12">
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            infrastructure, or exploring embedded finance - we would love to
        ...
        <div className="grid lg:grid-cols-3 gap-10 items-start">
          ...
          <aside className="space-y-6">
            ...
            <div className="glass-panel rounded-2xl p-6 text-sm text-gray-200">
              <h2 className="text-cream font-semibold mb-2">Direct contact</h2>
            ...
            <div className="glass-panel rounded-2xl p-6 text-sm">
              <h3 className="text-cream font-semibold mb-2">Office</h3>

              <p className="text-gray-300">
                206 Rajkamal Plaza A Navjivan, Ahmedabad Gujarat, India
              </p>
            </div>
          </aside>
        </div>
